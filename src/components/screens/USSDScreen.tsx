          ...
          <div className="space-y-1 mt-3">
            <Card className="bg-muted/30">
              <CardContent className="p-4 space-y-2">
                ...
                {(user?.agentCode || user?.agentNumber) && <div className="flex justify-between text-sm"><span className="text-muted-foreground">Code agent</span><span className="font-mono font-semibold text-emerald-700">{(() => {
